...
public final class FollowAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> implements OnGroupClickListener, Filterable {
    ...
    private final Filter filter = new Filter() {
        ...
        protected FilterResults performFiltering(CharSequence filter) {
            ...
            ArrayList<ExpandableGroup> groups = new ArrayList<ExpandableGroup>();
        ...
        protected void publishResults(CharSequence constraint, FilterResults results) {
            if (results == null) {
                ...
                ExpandableList filteredList = (ExpandableList) results.values;
                FollowAdapter.this.expandableList = filteredList;
            }
